...
import { Eye, Film, Heart, MessageCircle, Search, Sparkles, Trash2, ChevronLeft, ChevronRight } from 'lucide-react';
  ...
  return (
    <>
      <div className="space-y-5">
        <div>
          <p className="text-[11px] font-bold uppercase tracking-widest text-primary">Campaigns</p>
          <h1 className="text-xl font-bold text-neutral-900 mt-1">Campaigns</h1>
          <p className="text-sm text-neutral-500 mt-0.5">Manage Campaignsed bSpark content and engagement</p>
        </div>

        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            { label: 'Campaigns', value: totals.all, icon: Sparkles, color: 'text-primary bg-primary/10' },
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="border-b border-neutral-100 bg-neutral-50/50">
                  <th className="px-4 py-2.5 text-[11px] font-semibold uppercase tracking-wide text-neutral-500">Campaigns</th>
      ...
      <ConfirmModal
        ...
        description="Are you sure you want to delete this Campaigns? This action cannot be undone."
        confirmText="Delete"
